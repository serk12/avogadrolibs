...
LayerModel::LayerModel(QObject* p)
...
QList<Molecule*> LayerModel::molecules() const
{
  return m_molecules;
}

QList<Molecule*> LayerModel::activeMolecules() const
{
...
void LayerModel::setActiveMolecule(QObject* active)
{
...
void LayerModel::addItem(Molecule* item)
{
...
void LayerModel::removeItem(Molecule* item)
{
  if (m_molecules.contains(item)) {
